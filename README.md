...
```
cd existing_repo
git remote add origin https://gitlab.com/loyalty-group/loyalty.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/loyalty-group/loyalty/-/settings/integrations)
